...
class CategoryOndeFicar(models.Model):
	...
	class Meta:
		verbose_name = 'Categoria_OndeFicar'
	...
	def get_absolute_url(self):
		return reverse('ondeficar:category', kwargs={'slug': self.slug})
...
class OndeFicar(models.Model):
	...
	category = models.ForeignKey('ondeficar.CategoryOndeFicar', verbose_name='Categoria_OndeFicar')
	image_1 = models.ImageField(upload_to='images-ondeficar', verbose_name='Imagem_1', null=True, blank=True)
	decription_1 = models.CharField('Descrição-1', max_length=100, blank=True)
	image_2 = models.ImageField(upload_to='images-ondeficar', verbose_name='Imagem_2', null=True, blank=True)
	decription_2 = models.CharField('Descrição-2', max_length=100, blank=True)
	image_3 = models.ImageField(upload_to='images-ondeficar', verbose_name='Imagem_3', null=True, blank=True)
	decription_3 = models.CharField('Descrição-3', max_length=100, blank=True)
	image_4 = models.ImageField(upload_to='images-ondeficar', verbose_name='Imagem_4', null=True, blank=True)
	...
	def get_absolute_url(self):
		return reverse('ondeficar:ondeficar', kwargs={'slug': self.slug})


class ImageOndeficar(models.Model):
