    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_1', models.ImageField(blank=True, null=True, upload_to='images-praias', verbose_name='Imagem_1')),
                ('decription_1', models.CharField(blank=True, max_length=100, verbose_name='Descrição-1')),
                ('image_2', models.ImageField(blank=True, null=True, upload_to='images-praias', verbose_name='Imagem_2')),
                ('decription_2', models.CharField(blank=True, max_length=100, verbose_name='Descrição-2')),
                ('image_3', models.ImageField(blank=True, null=True, upload_to='images-praias', verbose_name='Imagem_3')),
                ('decription_3', models.CharField(blank=True, max_length=100, verbose_name='Descrição-3')),
                ('image_4', models.ImageField(blank=True, null=True, upload_to='images-praias', verbose_name='Imagem_4')),
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Criado em')),
                ('modified', models.DateTimeField(auto_now=True, verbose_name='Modificado em')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='praias.CategoryPraia', verbose_name='Categoria_Praias')),
            ],
            options={
