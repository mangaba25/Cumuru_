...
class ListarListView(generic.ListView):
	model = Artesanato
	template_name = 'artesanatos/lista-artesanatos.html'
...
class CategoryListView(generic.ListView):
	template_name = 'artesanatos/descricao-artesanatos.html'
	context_object_name = 'object_list'
	paginate_by = 8
...
def artesanato(request, slug):
	...
	return render(request, 'artesanatos/slide-artesanatos.html', context)
