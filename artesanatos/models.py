...
class Artesanato(models.Model):
	...
	image_1 = models.ImageField(upload_to='images-artesanatos', verbose_name='Imagem_1', null=True, blank=True)
	decription_1 = models.CharField('Descrição-1', max_length=100, blank=True)
	image_2 = models.ImageField(upload_to='images-artesanatos', verbose_name='Imagem_2', null=True, blank=True)
	decription_2 = models.CharField('Descrição-2', max_length=100, blank=True)
	image_3 = models.ImageField(upload_to='images-artesanatos', verbose_name='Imagem_3', null=True, blank=True)
	decription_3 = models.CharField('Descrição-3', max_length=100, blank=True)
	image_4 = models.ImageField(upload_to='images-artesanatos', verbose_name='Imagem_4', null=True, blank=True)
