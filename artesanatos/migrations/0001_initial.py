# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-10-18 14:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_1', models.ImageField(blank=True, null=True, upload_to='images-artesanatos', verbose_name='Imagem_1')),
                ('decription_1', models.CharField(blank=True, max_length=100, verbose_name='Descrição-1')),
                ('image_2', models.ImageField(blank=True, null=True, upload_to='images-artesanatos', verbose_name='Imagem_2')),
                ('decription_2', models.CharField(blank=True, max_length=100, verbose_name='Descrição-2')),
                ('image_3', models.ImageField(blank=True, null=True, upload_to='images-artesanatos', verbose_name='Imagem_3')),
                ('decription_3', models.CharField(blank=True, max_length=100, verbose_name='Descrição-3')),
                ('image_4', models.ImageField(blank=True, null=True, upload_to='images-artesanatos', verbose_name='Imagem_4')),
                ...
                ('contact', models.CharField(blank=True, max_length=100, verbose_name='Nome')),
        ...
        migrations.AddField(
            ...
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='artesanatos.CategoryArtesanato', verbose_name='Categoria_Artesanato'),
        ),
    ]
