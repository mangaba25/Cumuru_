# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-09-29 17:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_1', models.ImageField(blank=True, null=True, upload_to='images-servicos', verbose_name='Imagem_1')),
                ('decription_1', models.CharField(blank=True, max_length=100, verbose_name='Descrição-1')),
                ('image_2', models.ImageField(blank=True, null=True, upload_to='images-servicos', verbose_name='Imagem_2')),
                ('decription_2', models.CharField(blank=True, max_length=100, verbose_name='Descrição-2')),
                ('image_3', models.ImageField(blank=True, null=True, upload_to='images-servicos', verbose_name='Imagem_3')),
                ('decription_3', models.CharField(blank=True, max_length=100, verbose_name='Descrição-3')),
                ('image_4', models.ImageField(blank=True, null=True, upload_to='images-servicos', verbose_name='Imagem_4')),
